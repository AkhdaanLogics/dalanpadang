...
export default async function HomePage() {
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-7xl px-4 py-8 md:px-8 md:py-10">
      <header className="hero-gradient relative mb-8 overflow-hidden rounded-2xl border border-[#8a6a4f]/35 px-6 py-9 text-[#f8efe2] shadow-lg md:px-10">
        ...
        <div className="relative grid gap-6 lg:grid-cols-[1.4fr_1fr] lg:items-end">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-xl border border-[#d8c6b0]/35 bg-[#f8efe2]/10 p-3 text-center">
      ...
      <section className="glass-panel space-y-5 rounded-2xl p-4 md:p-6">
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full border border-[#c1ab92] bg-[#fff8f0] px-4 py-1.5 text-sm font-medium text-[#5a4639]">
